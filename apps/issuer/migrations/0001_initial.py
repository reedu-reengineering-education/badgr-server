    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badgeuser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='issuer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assertions', to='issuer.Issuer'),
            preserve_default=True,
        ),
        migrations.AddField(
