    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='composition.Collection')),
                ('instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='composition.LocalBadgeInstance')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='issuer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='composition.LocalIssuer', null=True),
