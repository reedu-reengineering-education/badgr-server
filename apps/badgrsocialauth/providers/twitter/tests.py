...
from badgrsocialauth.providers.twitter.provider import TwitterProviderWithIdentifier
...
class TwitterProviderTests(SendsVerificationEmailMixin, BadgrOAuth2TestsMixin, BadgrSocialAuthTestCase):
    provider_id = TwitterProviderWithIdentifier.id
