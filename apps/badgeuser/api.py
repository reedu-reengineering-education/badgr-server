...
from badgeuser.tasks import process_email_verification, process_post_recipient_id_verification
...
class BadgeUserEmailConfirm(BaseUserRecoveryView):
    ...
    def get(self, request, **kwargs):
        ...
        process_post_recipient_id_verification.delay(email_address, 'email')
